...
<html>
  <head>
    ...
    <!-- BASE CSS -->
    <link
      href="resources/udema_v_1.9/html_menu_1/css/bootstrap.min.css"
      rel="stylesheet"
    />
    <link
      href="resources/udema_v_1.9/html_menu_1/css/style.css"
      rel="stylesheet"
    />
    <link
      href="resources/udema_v_1.9/html_menu_1/css/vendors.css"
      rel="stylesheet"
    />
    <link
    ...
    <!-- admin CSS -->
    <link
      href="resources/udema_v_1.9/admin_section/css/admin.css"
      rel="stylesheet"
    />

    <!-- Calendar SPECIFIC CSS -->
    <link
      href="resources/udema_v_1.9/html_menu_1/css/fullcalendar.css"
      rel="stylesheet"
    />
    <link
    ...
    <!-- YOUR CUSTOM CSS -->
    <link
      href="resources/udema_v_1.9/html_menu_1/css/custom.css"
      rel="stylesheet"
    />
    <link
      href="resources/udema_v_1.9/admin_section/css/custom.css"
      rel="stylesheet"
    />
