	...
	$addCourse = function(course) {
		...
		if (course == "bigCourse") {
			if ($count > 3) {
				...
				$count += 1;
				$addHtml = '<div class="card"><div class="card-header" role="tab" id="heading' + $enCount[$count] + '"><h5 class="mb-0"><a data-toggle="collapse" href="#collapse' + $enCount[$count] + '" aria-expanded="true" aria-controls="collapse' + $enCount[$count] + '"><i class="indicator ti-minus"></i><input type="text" name="bigCourse' + $enCount[$count] + '" id="bigCourse' + $enCount[$count] + '" /></a></h5></div><div id="collapse' + $enCount[$count] + '" class="collapse show" role="tabpanel" aria-labelledby="heading' + $enCount[$count] + '"><div class="card-body"><input type="text" name="midCourse' + $enCount[$count] + '" id="midCourse' + $enCount[$count] + '" />&nbsp;&nbsp;&nbsp;<span>과정제목 추가</span><button type="button" id="addSmallBtn' + $enCount[$count] + '" class="btn btn-primary btnsIze"><small>추가</small></button><div class="list_lessons_2"><ul class="listBody' + $enCount[$count] + '"><li><input type="text" name="smallCourse' + $enCount[$count] + '_' + $numCount[0] + '" id="smallCourse' + $enCount[$count] + '_' + $numCount[0] + '" /></li></ul></div></div></div></div><!-- /card -->';
